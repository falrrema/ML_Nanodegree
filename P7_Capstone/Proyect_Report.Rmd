...
* Basic linear model: This second benchmark is my simple yet intelligent model, which I will try to beat with more complex models models. This logistic classifier will be trained on the crude words of the questions, without preprocessing. This will allow me to evaluate also the impact of my preprocessing step. 
